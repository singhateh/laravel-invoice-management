        ...
        <div id="table">
          <table class="table-main">
            ...
            <tr class="list-item" style="margin-bottom: 10px">
              ...
              <td data-label="Description" class="tableitem">{{ $user->name }}</td>
              <td data-label="Quantity" class="tableitem">{{ $user->email }}</td>
              <td data-label="Unit Price" class="tableitem">{{ $user->phone }}</td>
            </tr>
            @endforeach
          </table>
        </div><!--End Table-->
